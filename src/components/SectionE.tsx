  ...
  return (
    <div className="min-h-screen bg-white flex flex-col max-w-md mx-auto relative pb-28">
      ...
      <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto p-5 pb-8 bg-white border-t border-gray-100 flex gap-3">
        ...
        <button onClick={handleNext} disabled={isSaving} className={`flex-[2] py-4 rounded-2xl text-[18px] font-bold text-white transition-colors ${isSaving ? 'bg-[#d1d6db] cursor-not-allowed' : 'bg-[#3182f6] hover:bg-[#1b64da] active:bg-[#1b64da] shadow-lg shadow-blue-500/20'}`}>
